    ...
    <footer className="bg-gray-800 text-white">
      <div className="container mx-auto px-4 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><a href="mailto:support@samudrasetu.in" className="text-gray-400 hover:text-white transition-colors">support@samudrasetu.in</a></li>
      ...
      <div className="bg-gray-900 py-4">
        <div className="container mx-auto px-4 text-center text-gray-500">
          <p>&copy; {new Date().getFullYear()} SamudraSetu | Developed in collaboration with INCOIS</p>
        </div>
      </div>
    </footer>
  );
